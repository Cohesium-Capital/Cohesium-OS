-- setup-dev-db-part2.sql
-- Completes a partially-applied setup: migrations 003..018 only (all idempotent).
-- Safe to run repeatedly. Use after schema.sql baseline already exists.
